        ...
        <div className='container pb-20'>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 relative gap-4">
                ...
                <div
                    data-aos-duration="1000"
                    data-aos="fade-up"
                    className="py-10 px-10 flex gap-4 items-center exgradient rounded-xl z-10 border-t-2 border-light">
                ...
                <div
                    ...
                    data-aos="fade-up"
                    data-aos-delay="100"
                    className="py-10 px-10 flex gap-4 items-center exgradient2 rounded-xl z-10 border-t-2 border-light">
