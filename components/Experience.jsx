        ...
        <div className='w-[90%] md:w-[70%] lg:w-[70%]  mx-auto pb-20'>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 relative gap-4">
                ...
                <div className="py-10 px-10 flex gap-4 items-center exgradient rounded-xl z-10 border-t-2 border-[#693B93]">
                    ...
                    <div className="">
                        <h3 className='text-2xl font-poppins'>Software Engineer</h3>
                ...
                <div className="py-10 px-10 flex gap-4 items-center exgradient2 rounded-xl z-10 border-t-2 border-[#693B93]">
                    ...
                    <div className="">
                        <h3 className='text-2xl font-poppins'>Technical Author</h3>
                ...
                <div className="py-10 px-10 flex gap-4 items-center exgradient3 rounded-xl z-10 border-t-2 border-[#693B93]">
                    ...
                    <div className="">
                        <h3 className='text-2xl font-poppins'>Wordpress Developer</h3>
                        <h4 className='text-white text-md font-poppins'>Alegria - the festival of joy</h4>
                    </div>
                </div>
                <div className="py-10 px-10 flex font-poppins gap-4 items-center exgradient4 rounded-xl z-10 border-t-2 border-[#693B93]">
                    <img src="/freelance.png" alt="" />
                    <div className="">
                        <h3 className='text-2xl font-poppins'>Front End Developer</h3>
