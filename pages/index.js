        ...
        <div className={darkMode ? "dark" : ""}>
            ...
            <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900 ">
                <section className="">
                    ...
                    <div className="flex items-center mt-20 mb-44">
                        <div className=" text-center p-10 ">
                            ...
                            <p className="text-lg py-5 leading-8 max-w-xl mx-auto text-gray-500 md:text-xl">
                        ...
                        <div className="relative bg-gradient-to-b overflow-hidden from-teal-500 rounded-full w-80 h-80 mt-20 mx-auto lg:h-96 lg:w-96 ">
                            <Image
                                src="/dev-ed-wave.png"
                                layout="fill"
                                objectFit="cover"
                ...
                <h3 className="text-6xl py-1 mt-5 dark:text-white text-center mt-14">
                    Skills
                </h3>
